...
Write-Host ""
Write-Host "OpenEscrow reserve-only Base Sepolia deployment" -ForegroundColor Cyan
Write-Host "The current OpenEscrow and all existing agreement IDs will be preserved."
...
Write-Host ""
Write-Host "Reserve deployment completed successfully. You can close this window." -ForegroundColor Green
